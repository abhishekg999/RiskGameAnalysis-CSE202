from typing import List, Tuple, Set, Callable, NamedTuple, Generator
...
@InternalGameFunction
def ValidAttackSourceForPlayer(instance: GameInstance, state: GameState, p: int) -> Generator[int, None, None]:
...
def Alg1CMaxTAttacker(instance: GameInstance, state: GameState, p: int) -> int:
	...
	while stack:
		...
		for v in ValidAttackSourceForPlayer(instance, state, p):
